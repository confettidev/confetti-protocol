...
task("confetti:dev", "Deploy development enviroment")
  .addFlag("verify", "Verify contracts at Etherscan")
  .setAction(async ({ verify }, localBRE) => {
    const POOL_NAME = ConfigNames.Confetti;
    ...
    //////////////////////////////////////////////////////////////////////////
    console.log("\n\nDeploy mock cnft registry");
    await localBRE.run("dev:deploy-mock-cnft-registry", {
      verify,
      pool: POOL_NAME,
    });

    console.log("\n\nDeploy mock cnft tokens");
    await localBRE.run("dev:deploy-mock-cnft-tokens", {
      verify,
      pool: POOL_NAME,
    });
