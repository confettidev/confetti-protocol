...
import { rateStrategyStableOne } from "../markets/confetti/rateStrategies";

import { strategyDAI } from "../markets/confetti/reservesConfigs";
import { CToken, InterestRate, MintableERC20 } from "../types";
