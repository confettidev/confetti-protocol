...
export enum eContractid {
  ...
  ConfettiUpgradeableProxy = "ConfettiUpgradeableProxy",
  ConfettiProxyAdminTest = "ConfettiProxyAdminTest",
  ConfettiProxyAdminPool = "ConfettiProxyAdminPool", //LendPool Contracts, etc Oracle(Reserve, NFT)
  ConfettiProxyAdminFund = "ConfettiProxyAdminFund", //Treasury Fundings, etc Collector
  WalletBalanceProvider = "WalletBalanceProvider",
  CToken = "CToken",
  DebtToken = "DebtToken",
  CNFT = "CNFT",
  MockCNFT = "MockCNFT",
  ConfettiProtocolDataProvider = "ConfettiProtocolDataProvider",
  ...
  CNFTRegistryImpl = "CNFTRegistryImpl",
  ...
  ConfettiCollector = "ConfettiCollector",
  ConfettiCollectorImpl = "ConfettiCollectorImpl",
...
export enum ProtocolLoanState {
  ...
  Active,
  // The loan has been set to BuyItNow, debt have been repaid to the pool and the collateral is held.
  BuyItNow,
...
export enum ProtocolErrors {
  ...
  LP_CALLER_MUST_BE_AN_CTOKEN = "410",
  ...
  LPL_BUYITNOW_PRICE_LESS_THAN_LIQUIDATION_PRICE = "484",
  LPL_BUYITNOW_PRICE_LESS_THAN_HIGHEST_PRICE = "485",
  LPL_BUYITNOW_REDEEM_DURATION_HAS_END = "486",
  LPL_BUYITNOW_USER_NOT_SAME = "487",
  LPL_BUYITNOW_REPAY_AMOUNT_NOT_ENOUGH = "488",
  LPL_BUYITNOW_DURATION_HAS_END = "489",
  LPL_BUYITNOW_DURATION_NOT_END = "490",
  LPL_BUYITNOW_PRICE_LESS_THAN_BORROW = "491",
  LPL_INVALID_BUYITNOW_BUYER_ADDRESS = "492",
  LPL_AMOUNT_LESS_THAN_BUYITNOW_FINE = "493",
  LPL_INVALID_BUYITNOW_FINE = "494",
  LPL_BUYITNOW_DURATION_NOT_START = "495",
  ...
  RC_INVALID_BUYITNOW_DURATION = "736",
...
export type iConfettiPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  "WETH" | "DAI"
  //| 'BUSD'
  // | "USDC"
...
export type iMultiPoolsAssets<T> = iAssetCommon<T> | iConfettiPoolAssets<T>;

export type iConfettiPoolTokens<T> = Omit<iConfettiPoolAssets<T>, "ETH">;
...
export type iMultiPoolsNfts<T> = iNftCommon<T> | iConfettiPoolNfts<T>;

export type iConfettiPoolNfts<T> = iNftBase<T>;
...
export interface IReserveParams
  ...
  cTokenImpl: eContractid;
  reserveFactor: string;
  strategy: IInterestRateStrategyParams;
}

export interface INftParams extends INftBuyItNowParams, INftCollateralParams {
  cNFTImpl: eContractid;
}
...
export interface INftBuyItNowParams {
  redeemDuration: string;
  buyItNowDuration: string;
  redeemFine: string;
  redeemThreshold: string;
  minBuyItNowFine: string;
}
...
export interface IMocksConfig {
  CNFTNamePrefix: string;
  CNFTSymbolPrefix: string;
...
export interface ICommonConfiguration {
  ...
  CNFTRegistry: iParamsPerNetwork<tEthereumAddress | undefined>;
...
export interface IConfettiConfiguration extends ICommonConfiguration {
  ReservesConfig: iConfettiPoolAssets<IReserveParams>;
  NftsConfig: iConfettiPoolNfts<INftParams>;
}
...
export type PoolConfiguration = ICommonConfiguration | IConfettiConfiguration;
