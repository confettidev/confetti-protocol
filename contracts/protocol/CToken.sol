...
/**
 * @title ERC20 CToken
 * @dev Implementation of the interest bearing token for the Confetti protocol
 * @author Confetti
 */
contract CToken is Initializable, ICToken, IncentivizedERC20 {
    ...
    /**
     * @dev Returns the address of the Confetti treasury, receiving the fees on this cToken
     **/
