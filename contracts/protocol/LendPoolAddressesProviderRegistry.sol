 ...
 * @dev Main registry of LendPoolAddressesProvider of multiple Confetti protocol's markets
 * - Used for indexing purposes of Confetti protocol's markets
 * - The id assigned to a LendPoolAddressesProvider refers to the market it is connected with,
 *   for example with `1` for the Confetti main market and `2` for the next created
 * @author Confetti
 **/
contract LendPoolAddressesProviderRegistry is
    Ownable,
